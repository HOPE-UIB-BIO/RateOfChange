...
tibble_Europe_Roc <-  tibble_Europe2[c(1-30),] %>%
...
# save.image("~/HOPE/GITHUB/RateOfChange/ENV20200401.RData")
...
fc_draw_RoC(tibble_Europe_Roc,type = "singleplot", dataset.N = 4251, age.treshold = 8000)
